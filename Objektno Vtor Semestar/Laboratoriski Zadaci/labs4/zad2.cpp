...
class File{
    private:
        char *fileName{nullptr},*ownerName{nullptr}; Extension ext; int fileSize;
    public:
		...
		File(const File &other):File() { 
			if(this != &other){
				delete[] fileName; this->fileName = new char[strlen(other.fileName)+1]; strcpy(this->fileName,other.fileName);
				delete[] ownerName; this->ownerName = new char[strlen(other.ownerName)+1]; strcpy(this->ownerName,other.ownerName);
        ...
        ~File(){delete[] fileName; fileName = nullptr; delete[] ownerName; ownerName = nullptr;}
...
class Folder{
    ...
    public:
        ...
        ~Folder(){delete[] this->folderName; folderName = nullptr; delete[] this->arr; arr = nullptr;};
